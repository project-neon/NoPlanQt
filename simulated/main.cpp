...
int main(int argc, char *argv[]) {
    ...
    Robot *robot1 = new Robot(0, 1, 1, 200, 100, Robot::RobotTeamColor::BLUE, Sizes::VERY_SMALL, 41, 180);
    //robot1->config(Robot::RobotTeamColor::BLUE, Sizes::VERY_SMALL);
    Robot *robot2 = new Robot(0, 2, 0, 200, 256, Robot::RobotTeamColor::BLUE, Sizes::VERY_SMALL, 10, 180);
    //robot2->config(Robot::RobotTeamColor::BLUE, Sizes::VERY_SMALL);
    Robot *robot3 = new Robot(0, 3, 0, 200, 512, Robot::RobotTeamColor::BLUE, Sizes::VERY_SMALL, 55, 180);
    //robot3->config();
    Robot *robot4 = new Robot(0, 4, 0, 650, 100, Robot::RobotTeamColor::YELLOW, Sizes::VERY_SMALL, 0, 0);
   // robot4->config(Robot::RobotTeamColor::YELLOW, Sizes::VERY_SMALL);
    Robot *robot5 = new Robot(0, 5, 0, 650, 256, Robot::RobotTeamColor::YELLOW, Sizes::VERY_SMALL, 0, 0);
    //robot5->config(Robot::RobotTeamColor::YELLOW, Sizes::VERY_SMALL);
    Robot *robot6 = new Robot(0, 6, 0, 650, 512,Robot::RobotTeamColor::YELLOW, Sizes::VERY_SMALL, 0, 0);
